...
int threshold = 270;  //change this value to reflect the range of your muscle sensor
...
//  display.println("Take a deep breath");
...
//
//  }
    if (sensorValue > oldSensorValue+20) 
  {
    //ble.println(sensorValue);
    display.setTextSize(1.5);
    display.setTextColor(WHITE);
